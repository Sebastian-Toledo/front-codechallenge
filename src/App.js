...
import PresuConfigView from "views/Home/HomeConfigView";
            ...
            <>
              ...
              <div>
                ...
                <Route
                  ...
                  component={UserLessonListView}
                />
                <Route
                  path="/user-friendships/:user"
                  component={UserFriendshipListView}
                />
                <Route
                  path="/presupuesto/configuracion"
                  component={PresuConfigView}
                />
                <Route exact path="/">
                  <Redirect to="/users" />
                </Route>
